...
module.exports = class Transform {
    ...
    applyTransforms(baseTemplate, childTemplate,request,getServiceUrl) {
        ...
        const serializer = new CustomSerializer(rootNodes, serializerOptions,request,getServiceUrl);
